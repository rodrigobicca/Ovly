...
sap.ui.define([
	...
	"Ovly/relatorioDeFonecedorer/test/flpSandbox"
	...
	return Opa5.extend("Ovly.relatorioDeFonecedorer.test.integration.arrangements.FLP", {
		/**
		...
		iRestartTheAppWithTheRememberedItem: function (oOptions) {
			this.waitFor({
				success: function () {
					...
					oOptions.hash = "Suppliers/" + encodeURIComponent(sObjectId);
