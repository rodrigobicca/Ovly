		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#RelatoriodeFornecedores-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"RelatoriodeFornecedores-display": {
								"semanticObject": "RelatoriodeFornecedores",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Ovly.relatorioDeFonecedorer",
									"url": sap.ui.require.toUrl("Ovly/relatorioDeFonecedorer")
								}
							}
						}
					}
